...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA0, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X1D };//默认益杉
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA1, 0X00, 0X00, 0X01, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X1F };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA1, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X1E };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA2, 0X00, 0X00, 0X01, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X20 };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA2, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X1F };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA4, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X21 };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA5, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X22 };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA6, 0X00, 0X00, settime, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X02,
                         0X22 };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
...
{
    uint8_t temp[16] = { 0X33, 0X3E, 0X00, 0X0C, 0XA7, 0X00, 0X00, efficent, 0X00, 0X00, 0X00, 0X00, 0X00, 0X00, 0X01,
                         0X74 };
    uint8_t i = 0;
    for (i = 0; i < 16; i++) {
        write(temp[i]);
